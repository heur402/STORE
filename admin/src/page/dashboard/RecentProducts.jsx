        ...
        <table className="w-full text-sm">
          <thead>
            <tr className={`border-b ${styles.border}`}>
              <th
                className={`text-left pb-3 font-medium ${styles.text.secondary}`}
              >
                Product
              </th>
              <th
              ...
              <th
                className={`text-right pb-3 font-medium ${styles.text.secondary}`}
              >
                Price
              </th>
            </tr>
          ...
          <tbody>
            {products.map((product, index) => (
              <motion.tr
                ...
                whileHover={{
                  backgroundColor: styles.border.includes("gray-700")
                    ? "#374151"
                    : "#f9fafb",
                }}
                className={`border-b ${styles.border} last:border-0 transition-colors`}
              >
                <td className={`py-3 font-medium ${styles.text.primary}`}>
                  {product.name}
                </td>
                <td className="py-3">
                  <span
