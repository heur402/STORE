  ...
  return (
    ...
    >
      <div className="relative bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300">
        ...
        {/* IMAGE */}
        <div className="relative w-full lg:pb-[190%] pb-100">
          <motion.img
        ...
        {/* ================= DESKTOP HOVER ================= */}
        <div className="hidden lg:block absolute inset-0 bg-white/95 backdrop-blur-sm p-6 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              ...
              {showDesc && (
                ...
                >
                  <p className="text-gray-600 text-sm">
                    ...
                    <span
                      className={
                        isOutOfStock ? "text-red-700" : "text-green-500"
                      }
                    >
                      {product.stock}
                    </span>
